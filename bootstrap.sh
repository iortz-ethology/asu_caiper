...
MYSQL_PW="Ipe4u"
MYSQL_DRUPAL_PW="Ipe4u"
MYSQL_DRUPAL_PW_URL="Ipe4u"
DRUPAL_PW="Ipe4u!"
SITENAME="asu_ipe"
URL="dev.asu_ipe.local"
SSLPORT=443
WWW_DIR="drupal"
...
#mysql -u root -pIpe4u --database asu_ipe_drupal_web < /www/drupal/sites/dev-environment/assets/environ/dbbackup/asu_ipe_drupal_web.sql
